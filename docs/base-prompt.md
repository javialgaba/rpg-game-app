...
- The generated world atlas includes reusable `island_border_01` and `island_corner_01` frames so procedural boards have an intentional isometric island edge instead of ending abruptly against the blue/green page background.
